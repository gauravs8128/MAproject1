...
print("Enter 9 to Check whether a matrix is diagonalizable/ triangularizable or not")
print("Enter 10 for QR Factorization")
...
if number == 1:
 ...
 print("Determinant:", deter)
    ...
    #Check whether a matrix is diagonalizable/ triangularizable or not
  ...
  """
    ...
    for i, eigenvalue in enumerate(unique_eigenvalues):
     eigenspace_dim = np.linalg.matrix_rank(eigenvectors[:, eigenvalues == eigenvalue])
